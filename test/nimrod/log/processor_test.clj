...
(defonce test-store {:metric {}})
(defn test-set-metric [this metric-ns metric-id timestamp value tags]
...
(deftest process-log-line
  (testing "Process full log line"
    (binding [nimrod.core.metrics/store test-store nimrod.core.metrics/set-metric test-set-metric]
